...
func (c *SuiteClient) Token() (token string, err error) {
...
func (c *SuiteClient) TokenRefresh() (token string, err error) {
...
func (c *SuiteClient) getJSON(url_ string, response interface{}) (err error) {
