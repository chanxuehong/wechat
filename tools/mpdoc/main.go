...
func htmlDownload(name, url string) (err error) {
...
func main() {
	var mn Menu
	if err := xml.Unmarshal([]byte(src), &mn); err != nil {
		fmt.Println(err)
		return
	}
	for _, level1 := range mn.Level1List {
		fmt.Println(strings.TrimSpace(level1.H5.Text))
		for _, level2 := range level1.Body.Level2List {
	...
	for _, level1 := range mn.Level1List {
		for _, level2 := range level1.Body.Level2List {
			...
			if err := htmlDownload(text, href); err != nil {
    ...
    <div class="body">
        <ul>
            <li id="n-.E6.8E.A5.E5.8F.A3.E8.B0.83.E8.AF.95.E5.B7.A5.E5.85.B7">
                <a href="http://mp.weixin.qq.com/debug/">
                    接口调试工具
                </a>
            </li>
            <li id="n-.E6.8E.A5.E5.8F.A3.E4.BD.93.E9.AA.8C.E6.B5.8B.E8.AF.95.E5.8F.B7.E7.94.B3.E8.AF.B7">
                <a href="http://mp.weixin.qq.com/debug/cgi-bin/sandbox?t=sandbox/login">
                    接口体验测试号申请
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E6.96.B9.E6.A1.88.E6.A6.82.E8.BF.B0">
                <a href="../13/80a1a25adbc46faf2716774c423b3151.html">
                    方案概述
                </a>
            </li>
            <li id="n-.E6.8E.A5.E5.85.A5.E6.8C.87.E5.BC.95">
                <a href="../0/61c3a8b9d50ac74f18bdf2e54ddfc4e0.html">
                    接入指引
                </a>
            </li>
            <li id="n-.E6.8A.80.E6.9C.AF.E6.96.B9.E6.A1.88">
                <a href="../2/3478f69c0d0bbe8deb48d66a3111ff6e.html">
                    技术方案
                </a>
            </li>
            <li id="n-.E5.BC.80.E5.8F.91.E8.80.85FAQ">
                <a href="../1/66bc8fb495f80faeacc65cfb8d931acd.html">
                    开发者FAQ
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E8.8E.B7.E5.8F.96access_token">
                <a href="../11/0e4b294685f817b95cbed85ba5e82b8f.html">
                    获取access_token
                </a>
            </li>
            <li id="n-.E8.8E.B7.E5.8F.96.E5.BE.AE.E4.BF.A1.E6.9C.8D.E5.8A.A1.E5.99.A8IP.E5.9C.B0.E5.9D.80">
                <a href="../0/2ad4b6bfd29f30f71d39616c2a0fcedc.html">
                    获取微信服务器IP地址
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E8.A2.AB.E5.8A.A8.E5.9B.9E.E5.A4.8D.E7.94.A8.E6.88.B7.E6.B6.88.E6.81.AF">
                <a href="../14/89b871b5466b19b3efa4ada8e577d45e.html">
                    被动回复用户消息
                </a>
            </li>
            <li id="n-.E5.AE.A2.E6.9C.8D.E6.8E.A5.E5.8F.A3">
                <a href="../1/70a29afed17f56d537c833f89be979c9.html">
                    客服接口
                </a>
            </li>
            <li id="n-.E9.AB.98.E7.BA.A7.E7.BE.A4.E5.8F.91.E6.8E.A5.E5.8F.A3">
                <a href="../15/5380a4e6f02f2ffdc7981a8ed7a40753.html">
                    高级群发接口
                </a>
            </li>
            <li id="n-.E6.A8.A1.E6.9D.BF.E6.B6.88.E6.81.AF.E6.8E.A5.E5.8F.A3">
                <a href="../17/304c1885ea66dbedf7dc170d84999a9d.html">
                    模板消息接口
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E7.94.9F.E6.88.90.E5.B8.A6.E5.8F.82.E6.95.B0.E7.9A.84.E4.BA.8C.E7.BB.B4.E7.A0.81">
                <a href="../18/28fc21e7ed87bec960651f0ce873ef8a.html">
                    生成带参数的二维码
                </a>
            </li>
            <li id="n-.E9.95.BF.E9.93.BE.E6.8E.A5.E8.BD.AC.E7.9F.AD.E9.93.BE.E6.8E.A5.E6.8E.A5.E5.8F.A3">
                <a href="../10/165c9b15eddcfbd8699ac12b0bd89ae6.html">
                    长链接转短链接接口
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E5.BE.AE.E4.BF.A1JS-SDK.E8.AF.B4.E6.98.8E.E6.96.87.E6.A1.A3">
                <a href="../7/aaa137b55fb2e0456bf8dd9148dd613f.html">
                    微信JS-SDK说明文档
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E5.BE.AE.E4.BF.A1.E5.B0.8F.E5.BA.97.E6.8E.A5.E5.8F.A3">
                <a href="../8/703923b7349a607f13fb3100163837f0.html">
                    微信小店接口
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E5.BE.AE.E4.BF.A1.E5.8D.A1.E5.88.B8.E6.8E.A5.E5.8F.A3">
                <a href="../9/d8a5f3b102915f30516d79b44fe665ed.html">
                    微信卡券接口
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E8.AF.AD.E4.B9.89.E7.90.86.E8.A7.A3.E6.8E.A5.E5.8F.A3">
                <a href="../0/0ce78b3c9524811fee34aba3e33f3448.html">
                    语义理解接口
                </a>
            </li>
        </ul>
    ...
    <div class="body">
        <ul>
            <li id="n-.E8.AE.BE.E5.A4.87.E5.8A.9F.E8.83.BD.E4.BB.8B.E7.BB.8D">
                <a href="../5/131b418c04b1f4fc1752f7652b14b235.html">
                    设备功能介绍
                </a>
            </li>
        </ul>
