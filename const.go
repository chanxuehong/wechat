...
const (
	...
	accessTokenGetUrlFormat = `https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=%s&secret=%s`
	// https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN
	messageCustomSendUrlPrefix = `https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=`
	// https://api.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=ACCESS_TOKEN
	messageMassSendByGroupUrlPrefix = `https://api.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=`
	// https://api.weixin.qq.com/cgi-bin/message/mass/send?access_token=ACCESS_TOKEN
	messageMassSendByOpenIdUrlPrefix = `https://api.weixin.qq.com/cgi-bin/message/mass/send?access_token=`
	// https://api.weixin.qq.com//cgi-bin/message/mass/delete?access_token=ACCESS_TOKEN
	messageMassDeleteUrlPrefix = `https://api.weixin.qq.com//cgi-bin/message/mass/delete?access_token=`
