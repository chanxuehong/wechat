...
type MovieTicketUpdateUserParameters struct {
	...
	TicketClass   string `json:"ticket_class"`   // 电影票的类别，如2D、3D
	ShowTime      int64  `json:"show_time"`      // 电影放映时间对应的时间戳。
	Duration      int    `json:"duration"`       // 放映时长，填写整数
	ScreeningRoom string `json:"screening_room"` // 该场电影的影厅信息
