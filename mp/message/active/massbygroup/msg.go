...
// 新建文本消息
func NewText(isToAll bool, groupId int64, content string) *Text {
	var msg Text
	msg.Filter.IsToAll = isToAll
...
// 新建图片消息
//  mediaId 通过上传多媒体文件得到
func NewImage(isToAll bool, groupId int64, mediaId string) *Image {
	var msg Image
	msg.Filter.IsToAll = isToAll
	msg.Filter.GroupId = groupId
...
// 新建语音消息
//  mediaId 通过上传多媒体文件得到
func NewVoice(isToAll bool, groupId int64, mediaId string) *Voice {
	var msg Voice
	msg.Filter.IsToAll = isToAll
	msg.Filter.GroupId = groupId
...
func NewVideo(isToAll bool, groupId int64, mediaId string) *Video {
	var msg Video
	msg.Filter.IsToAll = isToAll
	msg.Filter.GroupId = groupId
...
func NewNews(isToAll bool, groupId int64, mediaId string) *News {
	var msg News
	msg.Filter.IsToAll = isToAll
	msg.Filter.GroupId = groupId
