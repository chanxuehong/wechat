...
type MenuLocationSelectEvent struct {
	...
	SendLocationInfo struct {
		LocationX string `xml:"Location_X"   json:"Location_X"` // 地理位置纬度
		LocationY string `xml:"Location_Y"   json:"Location_Y"` // 地理位置经度
		Scale     string `xml:"Scale"   json:"Scale"`           // 精度，可理解为精度或者比例尺、越精细的话 scale越高
