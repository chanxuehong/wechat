...
func (msg *Request) TextRequest() *TextRequest {
	var r TextRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
...
func (msg *Request) ImageRequest() *ImageRequest {
	var r ImageRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
...
func (msg *Request) VoiceRequest() *VoiceRequest {
	var r VoiceRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
	r.MediaId = msg.MediaId
...
func (msg *Request) VoiceRecognitionRequest() *VoiceRecognitionRequest {
	var r VoiceRecognitionRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
	r.MediaId = msg.MediaId
	r.Format = msg.Format
...
func (msg *Request) VideoRequest() *VideoRequest {
	var r VideoRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
	r.MediaId = msg.MediaId
...
func (msg *Request) LocationRequest() *LocationRequest {
	var r LocationRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
...
func (msg *Request) LinkRequest() *LinkRequest {
	var r LinkRequest
	r.RequestHead = msg.RequestHead
	r.MsgId = msg.MsgId
	r.Title = msg.Title
